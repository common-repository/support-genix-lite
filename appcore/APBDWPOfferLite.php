 ...
 * Class.
 */
if ( ! class_exists( 'APBDWPOfferLite' ) ) {
    final class APBDWPOfferLite {
        ...
        public function __construct() {
            ...
            $this->initial_page = admin_url( 'admin.php?page=support-genix-lite' );
            $this->screen_base = 'toplevel_page_support-genix-lite';
